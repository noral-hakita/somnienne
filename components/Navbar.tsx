  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 px-6 md:px-12 py-5 transition-all duration-500 ${
      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <Link href="/" className="font-serif text-2xl tracking-[0.2em] uppercase text-espresso">Somnienne</Link>
        <ul className="hidden md:flex items-center gap-10 list-none">
          <li><Link href="/collection" className="text-xs uppercase tracking-[0.25em] text-espresso/70 hover:text-bronze transition-colors duration-300">Collection</Link></li>
          <li><Link href="/story" className="text-xs uppercase tracking-[0.25em] text-espresso/70 hover:text-bronze transition-colors duration-300">Our Story</Link></li>
        </ul>
